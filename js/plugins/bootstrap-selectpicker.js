    ...
    (function($) {
        ...
        Selectpicker.prototype = {
            ...
            setSelected: function(index, selected, liIndex, li) {
                ...
                var selector = document.getElementById("select-language");
                ...
                if (a && value === "ru") {
                    a.setAttribute('data-google-lang', 'ru');
                    a.classList.toggle('active', keepActive);
                    a.setAttribute('aria-selected', true);
                }
                if (a && value === "ukr") {
                    a.setAttribute('data-google-lang', 'uk');
                    a.classList.toggle('active', keepActive);
                    a.setAttribute('aria-selected', true);
                }
                if (a && value === "eng") {
                    a.setAttribute('data-google-lang', 'en');
                    a.classList.toggle('active', keepActive);
                    a.setAttribute('aria-selected', true);
                }
